...
import { uploadBillingCsv, getAllBillingUploads, getUploadById, s3Ingest } from './billing.controller.js';
...
router.get('/get-billing-upload/:uploadId', decodeUser, getUploadById);

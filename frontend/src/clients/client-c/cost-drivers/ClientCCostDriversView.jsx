...
export function ClientCCostDriversView({
  ...
  return (
    <div className="p-4 space-y-4 min-h-screen bg-[#f8faf9] text-slate-800 font-sans animate-in fade-in duration-500 relative">
        ...
        {!selectedDriver ? (
          ...
          >
            ...
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4">
              ...
              <div className="flex items-center gap-2 bg-[#ffffff] p-1 rounded-xl border border-slate-200">
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                {/* Waterfall Bridge */}
                <div className="lg:col-span-2 bg-[#ffffff] border border-slate-200 rounded-xl p-4 flex flex-col sm:flex-row gap-6 items-center shadow-lg">
                ...
                {/* Dynamics / Tree Map */}
                <div className="bg-[#ffffff] border border-slate-200 rounded-xl p-4 relative shadow-lg">
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <button
                      ...
                      className={[
                        ...
                        showTreeMap
                          ? 'bg-[#1EA88A] text-white border border-[#1EA88A] shadow-[0_0_8px_rgba(30,168,138,0.4)]'
                          : 'bg-white/95 hover:bg-black/60 text-gray-400 hover:text-gray-200 border border-slate-200',
                      ].join(' ')}
                      title="Toggle View"
                    >
                  ...
                  {showTreeMap ? (
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-emerald-50 p-2 rounded-lg border border-slate-200">
            ...
            <div className="relative">
              {hasNoDrivers ? (
                <div className="flex flex-col items-center justify-center py-20 bg-[#ffffff] border border-slate-200 rounded-xl">

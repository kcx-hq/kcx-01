...
const FullScreenLoader = () => (
  <div className="flex items-center justify-center h-[70vh]">
    <div className="flex flex-col items-center gap-4">
      <svg
        className="w-12 h-12 animate-spin text-[#23a282]"
        fill="none"
        viewBox="0 0 24 24"
      >
        <circle
  ...
  const renderQuickStats = () => {
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-[#1a1b20]/60 backdrop-blur-md border border-white/5 rounded-xl p-4 hover:border-[#23a282]/20 transition-all duration-200">
        ...
        <div className="bg-[#1a1b20]/60 backdrop-blur-md border border-white/5 rounded-xl p-4 hover:border-[#23a282]/20 transition-all duration-200">
          ...
          <div className="text-2xl font-bold text-[#23a282]">{selectedIndices?.size || '0'}</div>
      ...
      <div className="flex flex-wrap items-center gap-3 mb-4 p-4 bg-[#1a1b20]/50 backdrop-blur-md rounded-xl border border-white/5 shadow-lg">
        ...
        <div className="relative flex-1 min-w-[200px] max-w-md">
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-[#0f0f11] border border-white/10 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#23a282] focus:border-transparent transition-all"
          />
        ...
        <div className="flex bg-[#0f0f11] rounded-lg border border-white/10 p-0.5">
          <button
            ...
            className={`px-3 py-1.5 text-sm rounded-md transition-all ${
              viewMode === "table"
                ? "bg-[#23a282] text-white shadow-sm"
        ...
        <button
          ...
          className={`px-3 py-2 bg-[#0f0f11] border border-white/10 rounded-lg text-sm transition-all ${
            showAggregates
              ? "text-[#23a282] border-[#23a282]/50 bg-[#23a282]/10"
        ...
        <button
          ...
          disabled={loading}
          className="px-4 py-2 bg-[#23a282] hover:bg-[#23a282] text-white rounded-lg text-sm flex items-center gap-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-[#23a282]/20"
        >
      ...
      {Object.keys(columnFilters).length > 0 && (
        <div className="flex flex-wrap gap-2 mb-4">
          {Object.entries(columnFilters).map(([key, value]: [string, string]) => (
            <div
              key={key}
              className="flex items-center gap-2 px-3 py-1.5 bg-[#23a282]/20 text-[#23a282] rounded-lg text-sm border border-[#23a282]/30"
            >
              <span>{key}: {value}</span>
              <button
                  ...
                  {visibleColumns.map((column: string) => (
                    <td key={column} className="px-4 py-2 sticky top-0 z-[40] bg-[#25262b]">
                      <input
                        ...
                        className="w-full px-2 py-1 bg-[#0f0f11] border border-white/10 rounded text-white text-xs focus:outline-none focus:ring-1 focus:ring-[#23a282]"
                      />
                    </td>
                  ))}
                </tr>
                    ...
                    return (
                      ...
                      >
                        ...
                        {showDataBars && typeof numericValue === 'number' && !isNaN(numericValue) && (
                          <div className="absolute left-0 top-0 bottom-0 bg-[#23a282]/10 rounded-r"

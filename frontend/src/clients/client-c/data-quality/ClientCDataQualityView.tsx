...
import type {
  ClientCDataQualityViewProps,
  LegendPayloadItem,
  PieTooltipFormatterPayload,
  QualityIssue,
} from "./types";
            ...
            <div className="bg-[#1a1b20]/60 backdrop-blur-md border border-white/5 p-5 rounded-2xl shadow-xl">
              <div className="flex items-center justify-between">
                ...
                <div className="p-3 bg-[#23a282]/20 rounded-lg">
                  <ShieldCheck className="text-[#23a282]" size={24} />
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-[#1a1b20]/60 backdrop-blur-md border border-white/5 rounded-2xl p-5 shadow-xl">
              <div className="flex items-center gap-2 mb-4">
                <BarChart size={16} className="text-[#23a282]" />
            ...
            <div className="bg-[#1a1b20]/60 backdrop-blur-md border border-white/5 rounded-2xl p-5 shadow-xl">
              <div className="flex items-center gap-2 mb-4">
                <FileText size={16} className="text-[#23a282]" />
              ...
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    ...
                    >
                      {extractedData.qualityIssues.map((entry: QualityIssue, index: number) => (
                    ...
                    <Tooltip 
                      ...
                      formatter={(value: number, name: string, props: PieTooltipFormatterPayload) => {
                        try {
                      ...
                      labelFormatter={(label: string) => {
                        try {
                          const total = extractedData.qualityIssues.reduce((sum: number, issue: QualityIssue) => sum + issue.count, 0);
                          const currentItem = extractedData.qualityIssues.find((issue: QualityIssue) => issue.type === label);
...
Percentage: ${percentage}% of total issues`;
                    ...
                    <Legend 
                      ...
                      content={(props: { payload?: LegendPayloadItem[] }) => {
                        const safePayload = props.payload || [];
                        ...
                        return (
                          <div className="text-xs text-gray-300 ml-4 max-w-[120px]">
                            {safePayload.slice(0, 8).map((entry: LegendPayloadItem, index: number) => {
                              const originalLabel = String(entry.payload?.type || entry.value || "Unknown");
                            ...
                            {safePayload.length > 8 && (
                              <div className="text-[10px] text-gray-500 mt-2">+{safePayload.length - 8} more</div>
                            )}
                          </div>
                        );
                      }}
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-700">
                ...
                <tbody className="divide-y divide-gray-800">
                  {extractedData.qualityIssues.map((issue: QualityIssue, index: number) => (

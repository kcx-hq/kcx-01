...
const OverviewStates = ({ type }) => {
  if (type === "loading") {
    return (
      <div className="animate-in fade-in zoom-in-95 duration-300 space-y-4">
        <div className="bg-[#ffffff]/80 backdrop-blur-xl border border-slate-200 p-8 rounded-xl text-center flex flex-col items-center justify-center min-h-[400px]">
          <Loader2 className="animate-spin text-[#1EA88A] mb-4" size={32} />
  ...
  // default empty
  return (
    <div className="bg-[#ffffff]/80 backdrop-blur-xl border border-slate-200 p-8 rounded-xl text-center">

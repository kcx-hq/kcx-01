...
export const SectionLoading = ({ label = "Analyzing Section..." }) => (
...
export const SectionRefreshOverlay = ({ label = "Updating...", rounded = "rounded-2xl" }) => (
...
export const SectionEmpty = ({ message = "No data available" }) => (
...
export const SectionError = ({ message = "Something went wrong" }) => (
